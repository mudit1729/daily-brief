...
# Core provider — always available
from langchain_openai import ChatOpenAI, AzureChatOpenAI

# Optional providers — lazy imports to avoid mandatory installs
def _lazy_import(module_name, class_name):
    """Return class from module, or None if not installed."""
    try:
...
ChatDeepSeek = _lazy_import('langchain_deepseek', 'ChatDeepSeek')
ChatGoogleGenerativeAI = _lazy_import('langchain_google_genai', 'ChatGoogleGenerativeAI')
ChatGroq = _lazy_import('langchain_groq', 'ChatGroq')
ChatXAI = _lazy_import('langchain_xai', 'ChatXAI')
GigaChat = _lazy_import('langchain_gigachat', 'GigaChat')
ChatOllama = _lazy_import('langchain_ollama', 'ChatOllama')

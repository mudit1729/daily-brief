...
from flask import Blueprint, render_template, request, abort, jsonify, current_app, session, redirect, url_for, Response
...
def prep_page():
    ...
    CATEGORIES = [
        ...
        {'label': 'ML Coding', 'icon': 'cpu', 'match': ['DeepML-', 'Transformers-ML150', 'PyTorch-']},
